...
from src.data.datasets.hoi4d import HOI4dDataset

from src.utils.projection import depthmap_to_world_coordinates, closed_form_inverse_se3


class HOI4dTestDataset(BaseTestDataset, HOI4dDataset):
    """hoi4d test dataset
        scene_info:
    ...
    def _get_views(self, idx):
        ...
        scene_meta = {
            "dataset_name": "hoi4d" if dataset_name is None else dataset_name,
